    ...
    >
      <div className="flex overflow-hidden rounded-xl border-2 border-brand bg-white shadow-[0_0_0_4px_rgba(224,123,0,0.08)] transition focus-within:shadow-[0_0_0_4px_rgba(224,123,0,0.15)]">
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="flex items-center gap-2 bg-brand px-5 text-sm font-bold text-white transition hover:bg-brand-strong disabled:cursor-not-allowed disabled:opacity-70"
        >
